...
import { salonActivityColumns } from '../shared/reportTables'
import type { SalonActivityRowDto } from '../types/dto/reports'
...
export function SalonActivityReportPage() {
  const [filters, setFilters] = useState(getDefaultPeriod())
  const [rows, setRows] = useState<SalonActivityRowDto[]>([])
  ...
  return (
    <section className="page-section">
      <div className="page-header">
        <div>
          <p className="eyebrow">Отчёт 2.2.2</p>
          <h2>Операционная активность филиалов</h2>
          <p className="section-description">
            Количество клиентов, выполненных услуг и выручка по филиалам за выбранный период.
          </p>
        </div>
      </div>
      ...
      <DataTable
        caption="Активность филиалов"
        columns={salonActivityColumns}
        rows={rows}
